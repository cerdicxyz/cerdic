...
- [x] 2. Shared TS type definitions for protocol constants
...
- [x] 3. Foundry + Solc 0.8.24 project in `packages/contracts`
...
- [x] 4. Cargo workspace in `packages/engine`
...
- [x] 5. Next.js 14 + TypeScript app in `packages/frontend`
...
- [x] 6. CI pipeline (GitHub Actions) — build, test, lint across all three stacks
...
- [x] 8. Clearing account contract — Account.sol
...
- [x] 9. Collateral engine contract — CollateralEngine.sol
...
- [x] 10. Position engine contract — PositionEngine.sol
...
- [x] 11. Settlement engine contract + IMarket interface — SettlementEngine.sol
...
- [x] 12. Oracle consumer — PythConsumer.sol + ChainlinkConsumer.sol
...
- [x] 13. Liquidation entry contract — LiquidationEntry.sol (isolated-margin version)
...
- [x] 14. BTC/USDC perpetual market extension — BtcPerpMarket.sol (with funding index)
...
- [x] 15. Risk monitor contract + Rust component — RiskMonitor.sol + crates/risk
...
- [x] 16. Rust CLOB matching engine — crates/clob
...
- [x] 17. On-chain order book storage contract for CLOB — OrderBook.sol
...
- [x] 21. Mark-price on-chain impact TWAP — MarketImpactTwap.sol
